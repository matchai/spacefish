...
* [API](/docs/API.md)
  ...
  * [__sf_lib_section](/docs/API.md#sf-lib-section-color-prefix-content-suffix)
  * [__sf_util_set_default](/docs/API.md#sf-util-set-default-command)
  * [__sf_util_git_branch](/docs/API.md#sf-util-git-branch-function))
